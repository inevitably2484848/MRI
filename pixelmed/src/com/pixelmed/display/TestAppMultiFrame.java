...
class TestAppMultiFrame extends ApplicationFrame {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/display/TestAppMultiFrame.java,v 1.16 2007/12/19 22:44:15 dclunie Exp $";
	...
	public static void main(String arg[]) { 
		...
		int y=0;
		while (f < nframes) {
			SingleImagePanel ip = new SingleImagePanel((ConstructImage) sImg);
