...
/**
 * This class represents the total tag object created when using tagged MRI. The
 * object consists of all the tag lines from the image.
 * 
 * @author Eric Turner
 *
 */
public class TagObject implements Serializable {
    private static final long serialVersionUID = 7564330072464642934L;
