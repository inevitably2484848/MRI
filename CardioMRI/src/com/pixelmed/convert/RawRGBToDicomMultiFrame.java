...
public class RawRGBToDicomMultiFrame {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/convert/RawRGBToDicomMultiFrame.java,v 1.2 2012/12/15 16:56:23 dclunie Exp $";
	...
	public static AttributeList generateDICOMPixelDataModuleAttributesFromRawRGBFiles(String[] inputFileNames,String inputFileNameSuffix,RawRGBInformation rawRGBInfo,AttributeList list) throws IOException, DicomException {
		...
		String photometricInterpretation = "RGB";
...

		{
			...
			if (inputFileNameSuffix.toUpperCase().endsWith(".GZ")) {
				long valueLength = numberOfFrames * rows * columns *samplesPerPixel;
				aPixelData = new OtherByteAttributeMultipleCompressedFilesOnDisk(TagFromName.PixelData,valueLength,inputFileNames);
			}
			else {
