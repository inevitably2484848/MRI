...
public class CompositeInstanceContext {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/CompositeInstanceContext.java,v 1.9 2014/03/01 19:22:17 dclunie Exp $";
	 ...
	 *
	 * @deprecated use  {@link #CompositeInstanceContext(AttributeList,boolean) CompositeInstanceContext(AttributeList,boolean)} instead
	 *
	 * @param	srcList
	 */
...
//System.err.println("CompositeInstanceContext.createPerformedProcedureCodeSequenceIfAbsent(): copying ProcedureCodeSequence to PerformedProcedureCodeSequence item "+item);
	 ...
	 * <p>Also populates the SR Document General Module specific {@link com.pixelmed.dicom.Attribute Attribute}s from their image equivalents.</p>
	 *
	 * @deprecated use  {@link #updateFromSource(AttributeList,boolean) updateFromSource(AttributeList,boolean)} instead
	 *
	 * @param	srcList
	 */
