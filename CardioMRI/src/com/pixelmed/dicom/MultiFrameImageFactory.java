...
public class MultiFrameImageFactory {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/MultiFrameImageFactory.java,v 1.28 2014/03/09 16:56:22 dclunie Exp $";
...
//System.err.println("MultiFrameImageFactory.addPlaneOrientationFunctionalGroupDerivedFromAngle(): is unit vector");
	...
	public static void addStack(AttributeList list,Map<String,StackOfSlices> stacks) {
		...
		try {
			...
			if (!stack.isValid()) {
System.err.println("addStack(): Could not make a valid stack");
				return;
			}
			String stackID = null;
			if (stacks != null) {
...
System.err.println("addStack(): Making new stack "+stackID);
			}
			else {
System.err.println("addStack(): Not replacing existing stack "+stackID);
			}
...
System.err.println("addStackIfNotAlreadyPresent(): Not replacing existing stack");
		}
	}
