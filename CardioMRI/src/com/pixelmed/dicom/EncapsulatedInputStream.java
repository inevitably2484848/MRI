 ...
 *
 * <p>Since an individual frame may be fragmented and padded with 0xff bytes beyond the
...
public class EncapsulatedInputStream extends InputStream {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/EncapsulatedInputStream.java,v 1.17 2014/04/04 00:08:23 dclunie Exp $";
...
//	}
	 ...
	 *
	 * <p>Do not use jpegEOIDetection for RLE encapsulated data.</p>
	 *
	 ...
	 *
	 * @param	i					the input stream to read from
	 * @param	jpegEOIDetection	whether or not to detect
	 */
	public EncapsulatedInputStream(BinaryInputStream i) {
		this(i,true/*jpegEOIDetection*/);
	}
