...
public class MoveSOPClassSCU extends SOPClass {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/MoveSOPClassSCU.java,v 1.18 2013/04/27 01:23:50 dclunie Exp $";
...
if (debugLevel > 1) System.err.println(new java.util.Date().toString()+": MoveSOPClassSCU: waiting for PDUs");
		try {
			association.waitForPDataPDUsUntilHandlerReportsDone();
if (debugLevel > 1) System.err.println(new java.util.Date().toString()+": MoveSOPClassSCU: got PDU, now releasing association");
			// State 6
			association.release();
		}
