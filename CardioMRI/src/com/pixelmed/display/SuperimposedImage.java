...
public class SuperimposedImage {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/display/SuperimposedImage.java,v 1.5 2014/03/20 18:31:40 dclunie Exp $";
...
//System.err.println("SuperimposedImage.AppliedToUnderlyingImage(): transform = "+transform);
										...
										// need to make the new image large enough to account for the tow and column offset in the trasnform, else gets clipped
