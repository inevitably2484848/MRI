...
/**
 * This class represents the images taken at a specific time. It contains only a
 * list of images.
 * 
 * @author Eric Turner
 *
...
public class Time implements Serializable {
    private static final long serialVersionUID = -8036205306349636260L;
    ...
    /**
     * Comparator for comparison and sorting of Time objects. Comparison based
     * on the TriggerTime field
     * 
