...
public final class ContourCalc {
    private static int SEPARATION_DISTANCE = 1; // Distance between each of the generated points
     ...
     * <li> Control points are sorted, so the order of the points in controlPoints
     * might change.</li>
     ...
     * @param generatedPoints List in which to put the generated points
    ...
    public static void generate(List<Point2D> controlPoints,
        ...
        for (int i = 0; i < rawPoints.size(); i++) {
            ...
            points[i] = new Vec2D((float) point2D.getX(), (float) point2D.getY());
        }
