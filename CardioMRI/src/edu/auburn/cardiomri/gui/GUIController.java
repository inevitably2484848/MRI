...
//System.out.println("GUIController : Cancel choosing file");
	 ...
	 */
	 private void saveContour() {
		 ...
		 DICOMImage dImage = this.mainImageModel.getImage();
		 Vector<Contour> contours = new Vector<Contour>();
		 contours = this.mainImageModel.getContourList();
		 int numPoints = 0;
...
//System.out.println("GUIController : updating new DICOM");
		...
		this.mainImageModel.setCurrentImage(this.gIndex, this.sIndex, this.tIndex, this.iIndex);
		this.mainImageModel.addContourToImage(new Contour(Contour.Type.DEFAULT));
		this.imageModelSmallLeft.setCurrentImage(this.gIndex, this.sIndex, this.tIndex, this.iIndex);
	 ...
	 */
	public ImageModel getImageModel() { return this.mainImageModel; }
