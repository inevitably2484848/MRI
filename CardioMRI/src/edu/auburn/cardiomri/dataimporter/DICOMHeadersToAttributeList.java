...
/**
 * This class provides a static method for acquiring an AttributeList
 * from a given DICOM filename. Utilizes the AttributeList class
 * from the PixelMed toolkit.
 * 
