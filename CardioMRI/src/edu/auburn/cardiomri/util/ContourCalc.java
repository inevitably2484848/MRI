...
//    }
    ...
    public static List<Point> genCurve(ControlPoint a, ControlPoint b) {
    	...
    	//calculates the distance vector to the first tension point 		   
 		double distanceAX = a.getTension1().getX() - a.getX();
 		double distanceAY = a.getTension1().getY() - a.getY();
 		
 		//calculates the distance vector to the second tension from the first tension point
 		double distanceBX = a.getTension2().getX() - a.getTension1().getX();
 		double distanceBY = a.getTension2().getY() - a.getTension1().getY();
 		
 		//calculates the distance vector to the second control point from the second tension
 		double distanceCX = b.getX() - a.getTension2().getX();
 		double distanceCY = b.getY() - a.getTension2().getY();
     	...
     	for(int j = 0; j < 101; j++) {
     		...
     		double bX = a.getTension1().getX() + (j * (distanceBX/100));
     		double bY = a.getTension1().getY() + (j * (distanceBY/100));
     		
     		//calculates the point j% along the line from the second tension point to the second control point
     		double cX = a.getTension2().getX() + (j * (distanceCX/100));
     		double cY = a.getTension2().getY() + (j * (distanceCY/100));
